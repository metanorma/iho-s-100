...
of the display planes for S-101 -- this one contains navigation aids. The
...
[[fig-16-A-17]]
.Example of display plane with S-101 features (informative)
image::img216.png[]

<<fig-16-A-18>> depicts an example of the use of the substitution
capabilities of an Interoperability Catalogue. The element
substituteSymbolization for S-101 feature CurrentNonGravitational has its
