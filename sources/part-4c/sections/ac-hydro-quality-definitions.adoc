...
+
--
The allowable topological levels are described in the IHO/DGIWG joint profile of
<<ISO19107>> Geographic Information Spatial Schema. Which particular topological structure may
be used with a specific dataset is defined in the Product Specification for that type
of data product, for example "Chain Node Topology" for <<S101>>.
...
+
--
NOTE: in <<ISO19115>>, this is "Correctness of the explicitly encoded topological
characteristics of a dataset", but <<ISO19138>> states that the measures "will not serve
as measures of the consistency of explicit descriptions of topology using the
topological objects specified in <<ISO19107>>", and S-100 does not explicitly encode
geometry.
--
