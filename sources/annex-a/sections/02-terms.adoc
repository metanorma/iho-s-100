...
all scripting functions which are defined outside <<Part13>>. The union of
...
an <<ISO8211>> implementation of a <<S57>> {{record}} and which comprises one
...
All scripting functions defined within <<Part13>>. The union of Standard
