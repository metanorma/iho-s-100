...
| 1
| RecordType
| Implemented externally as Feature Catalogue (S-100 Part 5) and feature information group (S-100 Part 10c)
...
reference texts (for example, the non-normative references in S-100 Part 10c).
